...
export const data = {
  ...
  sneakers: [
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "In 1985, Michael Jordan received the NBA&rsquo;s Rookie of the Year Award after launching his career with a remarkable point per game average and a thirst for success. To celebrate, Jordan Brand released the Air Jordan 1 Retro High OG &#39;Rookie of the Year.&#39; The high top features a white-based leather upper with perforations on the toe box for breathability and Gold Harvest leather overlays on the mudguard, ankle, eyestay, and heel. Hidden on the inside of each strap on the upper are callouts to MJ&rsquo;s outstanding rookie season. &lsquo;1984-85 R.O.Y. 2313 POINTS 28.2 PPG&rsquo; can be found on the inside of one strap, and a quote from Jordan can be found on the other.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "Arriving in stores in February 2018, the Air Jordan 1 Retro High OG &lsquo;Bred Toe&rsquo; is a new spin on a classic design. The Chicago Bulls-inspired colorway combines elements of the &lsquo;Bred&rsquo; and &lsquo;Black Toe&rsquo; editions of the Air Jordan 1, executed on a premium leather build. The high-top features a black Swoosh on the white quarter panel, along with contrasting pops of red on the toe box, heel, collar, and outsole. The shoe stays true to its OG 1985 roots with Nike Air branding on the tongue tag and sockliner.",
      upper_material: "Leather",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "Air Jordan 1 Retro High OG &lsquo;Origin Story&rsquo; was made to celebrate the animated film Spider-Man: Into the Spider-Verse. The high-top features a design that mirrors the pair worn by character Miles Morales, updating the classic Chicago colorway with an icy translucent rubber outsole and a subtle pattern of reflective dots across the shoe&rsquo;s red leather overlays.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
      ...
      status: "active",
      story_html:
        "The Air Jordan 12 Retro &lsquo;Gym Red&rsquo; presents a monochromatic take on Tinker Hatfield&rsquo;s 1996 design. The entirety of the mid-top silhouette is dipped in red, including the rubber tooling and herringbone tread outsole. Contrasting hits of black are used throughout the shoe&rsquo;s branding elements and sockliner. While the all-red finish presents a radical new look for the vintage silhouette, the performance benefits remain unchanged, highlighted by full-length Zoom Air that extends from heel to toe.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "Instead of the usual two-tone color blocking, the Air Jordan 1 Retro High OG &lsquo;Phantom&rsquo; makes use of contrast stitching in black and red to distinguish the high-top&rsquo;s clean lines. The shoe&rsquo;s all-leather upper is finished in off-white Sail, accented by a padded collar and underlayer Swoosh in University Red. True to its OG designation, the design is finished with Nike Air branding on the woven tongue tag and insole.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The 2018 edition of the Air Jordan 11 Retro &lsquo;Concord&rsquo; features &lsquo;45&rsquo; stamped on the black heel tab—a nod to the jersey number that Michael Jordan wore upon his return to basketball following his first retirement. The rest of the build keeps the shoe&rsquo;s signature details intact, including a white ballistic mesh upper, black patent leather overlays and an icy translucent outsole underfoot. ",
      upper_material: "",
    },
<<<<<<< Updated upstream
=======
    {
      ...
      status: "active",
      story_html:
        "The Air Jordan 11 Retro Low &lsquo;Navy Snakeskin&rsquo; returns for the first time since 2000. A true retro to the original, the 2019 version features leather panels on the upper instead of mesh and a translucent outsole, while the mudguard still features a navy snakeskin print.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
      ...
      status: "active",
      story_html:
        "The Air Jordan 4 Retro OG &#39;Cement&rsquo; 2016 was one of the original four colorways released in 1989. The sneaker features the original White, Fire Red, Black, and Tech Grey colorway, with the speckled Cement Grey accents that give the sneaker its nickname. Released during the 2016 NBA All-Star weekend in Toronto, the sneaker was also retro&rsquo;d in 1999 and 2012. The 1999 and 2016 retros are the only models that feature the &lsquo;Nike Air&rsquo; branding on the heel, just like the 1989 OG sneakers.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "The Champion Rally Pro sneaker packages street style in a sleek, basketball-inspired silhouette with heritage Champion detailing throughout. This &lsquo;Black&rsquo; version is styled for growing kids&rsquo; feet and features a one-piece bootie construction made from woven mesh and elastic textile with suede trim on the sidewall and heel. It offers a snug, sock-like fit that&rsquo;s reinforced with tabs at the tongue and heel for easy on and off. A textured chenille &lsquo;C&rsquo; logo on the sidewall and branded elastic strap across the forefoot complement the design.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "Tyler, the Creator teamed up with Foot Locker on the &lsquo;Artist Series&rsquo; edition of the Converse Chuck 70, featuring an off-white canvas upper printed with original artwork from Wyatt Navarro. The heightened foxing that&rsquo;s a signature design element of the silhouette is adorned with contrasting stripes in blue and orange. A gum rubber outsole delivers traction underfoot.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Gucci Pursuit &lsquo;72 Rubber Slide in &lsquo;Black&rsquo; sneaker pays homage to the fashion house&#39;s roots with the iconic Web stripe—first developed by Gucci in the 1950s—taking the stage. The minimal, open-toe silhouette features a thick black rubber sole with a rounded shape. The top portion of the slide is a rubber strap displaying the Gucci Web green and red striped motif, and the design is finished with a Gucci logo embossed on the outer midsole.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "In celebration of Air Max Day, Nike hosted the Nike: On Air contest in 2018, giving residents the chance to create their own Air Max designs inspired by their hometowns. After working alongside Nike developers, winner Gwang Shin debuted his Nike Air Max 97 &#39;Neon Seoul&#39; sneaker in April 2019. Paying tribute to his city, Seoul, Shin draws influences from the famed neon signs in South Korea&rsquo;s capital, decorating the leather upper with vivid-colored piping.",
      upper_material: null,
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "Nike and frequent collaborator Fear Of God designer, Jerry Lorenzo, joined forces once again for the Air Fear Of God Raid &#39;Black&#39; sneaker. Released in May 2019, the uniquely designed silhouette is inspired by one of Lorenzo&rsquo;s favorite Nike designs, the Air Raid. Outfitted with a cross strap suede and textile upper above; below, its equipped with a double stacked Zoom Air unit in heel for a retro, yet futuristic finish.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "The Off-White x Air Max 90 &lsquo;Black&rsquo; offers a unique blend of materials on the upper, which combines a ripstop base with nubuck overlays and a suede mudguard. The all-black finish is contrasted by a white Swoosh with zigzag stitching, a small orange tab on the quarter panel and orange stitching on the exposed-foam tongue. Virgil Abloh&rsquo;s signature text block makes an appearance on the shoe&rsquo;s medial side.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
      ...
      status: "active",
      story_html:
        "This monochromatic take on the Air Presto is the second time Virgil Abloh and Nike collaborated on this iconic silhouette. The July 2018 iteration came a few mere months after it&rsquo;s two-tone predecessor made it&rsquo;s debut as part of Abloh and Nike&rsquo;s &lsquo;The Ten&rsquo; Collection. This pair showcases an all-black finish, accented with unique touches including a plastic zip tie, white Swoosh with conspicuous zig-zag stitching, and lines of text on the medial quarter panel that allude to the shoe&rsquo;s Beaverton origins.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Off-White x Air Max 90 &lsquo;Desert Ore&rsquo; represents yet another of Virgil Abloh&rsquo;s fanciful takes on the retro silhouette. Unlike its stark black and white counterparts, this pair features a mixed-material upper dressed in a warm tan shade. A stitched-on in Swoosh in Bright Mango is joined by the usual Virgil flourishes, including a blue zip tie and lines of printed text on the medial side.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "The April 2018 version of Virgil Abloh&rsquo;s all-white Air VaporMax is mostly unchanged from the original pair from &lsquo;The Ten.&rsquo; Stripped of color, the performance runner brings raw materials and unique details to the forefront, including an exposed-foam tongue, translucent Swoosh and off-white suede eyestay. Printed above the clear VaporMax unit, the quotation &lsquo;AIR&rsquo; print on the lateral side takes on an extra meta dimension. ",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The &lsquo;Sail&rsquo; colorway of Travis Scott&rsquo;s Air Force 1 represents the Houston rapper&rsquo;s second collaboration with Nike on the classic silhouette. Aside from swapping out the all-white finish of its predecessor with slightly darker Sail, the new model is mostly unchanged. Tonal canvas construction is accented with removable Swooshes and tongue patches, while the shiny lace jewels give a nod to Scott&rsquo;s signature grill.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Vans Old Skool &lsquo;Yacht Club&rsquo; showcases bold color blocking inspired by traditional nautical flags. The shoe&rsquo;s upper is executed with canvas quarter panels in kelly green, overlaid with a white leather side stripe, and contrasted by a blue suede toe cap and yellow suede heel panel. The multi-color design rests on a crisp white rubber midsole, accented with Vans&rsquo; signature &lsquo;Off the Wall&rsquo; license plate in red.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The 5th Yeezy to drop since November 2017 — Yeezy Boost 350 V2 &#39;Semi Frozen Yellow&#39; and &lsquo;Beluga 2.0,&rsquo; Yeezy Powerphase Calabasas, and the Yeezy 500 &lsquo;Desert Rat&rsquo; — the Yeezy Boost 350 V2 &#39;Blue Tint&#39; was dropped on December 16th, 2017. The sneaker features a neutral white and grey upper with a red &lsquo;SPLY-350&rsquo; text on the side in reverse. The shoe also comes with a heel tab, blue tint inner lining, and paste blue laces.",
      upper_material: "Primeknit",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "With its name coming from the colorway similarities found on the first Yeezy Boost 350 V2, the Yeezy Boost 350 V2 &#39;Beluga 2.0&#39; dropped on November 25, 2017. It was quickly restocked on November 30th after selling out. The shoe features a muted grey stripe on the laterals instead of the bright orange stripe found on the original &lsquo;Beluga&rsquo; sneaker. The Yeezy Boost 350 V2 &#39;Beluga 2.0&#39; also features a heel pull tab with orange stitching and orange &lsquo;SPLY-350&rsquo; lettering in reverse on the laterals. ",
      upper_material: "Primeknit",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "The adidas Yeezy Boost 700 &lsquo;Inertia&rsquo; is part of the Yeezy Season 8 lineup that launched March 2019. The &lsquo;Inertia&rsquo; colorway showcases the original 700 upper, with a heavily paneled construction made with premium suede, mesh and smooth leather sections. Cast primarily in cool grey tones, the sneaker includes hits of Tangerine for contrast. The shoe&rsquo;s signature chunky midsole is equipped with full-length Boost cushioning for responsive comfort.",
      upper_material: "",
    },
    {
      box_condition: "no_original_box",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "The Yeezy Boost 350 V2 &lsquo;Static Non-Reflective&rsquo; is designed to stand out, thanks to the addition of never-before-seen features. They include a translucent side stripe and 3M reflective detailing on the shoe&rsquo;s rope laces, Primeknit upper and Three-Stripes branding on the interior heel. The midsole makes use of ridged TPU sidewalls with semi-translucent properties, revealing full-length adidas Boost cushioning within.",
      upper_material: "Primeknit",
    },
    {
      box_condition: "badly_damaged",
      ...
      status: "active",
      story_html:
        "Alongside an accompanying Crazy BYW, the Pharrell x Solar Hu Glide ST &lsquo;Chinese New Year&rsquo; rings in the Year of the Pig as part of a collaborative CNY Pack. The lifestyle runner features a red and black knitted upper with gold accents and special embroidery on the toe of each shoe: &lsquo;Hu&rsquo; on the right and the Chinese &lsquo;Fu&rsquo; symbol on the left. It all sits on a full-length Boost midsole in classic white.",
      upper_material: "",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "The adidas Yeezy Boost 350 V2 &lsquo;Clay&rsquo; updates the silhouette with a warm palette and semi-translucent, three-tone vent at the side. This &lsquo;Clay&rsquo; colorway retains the stand-out features of the original 350 V2 shoe, first seen in September 2016, including a flexible Primeknit upper and full-length Boost cushioning. This shoe released March 2019 exclusively in select cities in North America and Latin America.",
      upper_material: "Primeknit",
    },
    {
      box_condition: "no_original_box",
      ...
      status: "active",
      story_html:
        "First released on April 29, 2017, the Yeezy Boost 350 V2 &lsquo;Cream White&rsquo; combines a cream Primeknit upper with tonal cream SPLY 350 branding, and a translucent white midsole housing full-length Boost. Released again in October 2018, this retro helped fulfill Kanye West&rsquo;s oft-repeated &lsquo;YEEZYs for everyone&rsquo; Twitter mantra, as adidas organized the biggest drop in Yeezy history by promising pre-sale to anyone who signed up on the website. Similar to the first release, the &lsquo;Triple White&rsquo; 2018 model features a Primeknit upper, a Boost midsole and custom adidas and Yeezy co-branding on the insole.",
      upper_material: "Primeknit",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "The Yeezy Boost 700 &lsquo;Salt&rsquo; follows a design trail originally blazed by the Yeezy 500 in November 2018. Like its predecessor, the lifestyle silhouette features a monochromatic light grey finish on a mesh base with tonal overlays in suede and leather. A sculpted midsole in matching grey, concealing full-length Boost cushioning within, features a subtle black accent, matched by the rubber outsole underfoot.",
      upper_material: "",
    },
    {
      box_condition: "badly_damaged",
      ...
      status: "active",
      story_html:
        "Released on February 25, 2017, the Yeezy Boost 350 V2 &lsquo;Zebra&rsquo; combines a white/core black Primeknit upper with red SPLY 350 branding and a translucent white midsole housing full-length Boost. Sold exclusively at adidas.com, Yeezy Supply, and select adidas flagship stores, the &lsquo;Zebra&rsquo; sold out instantly but was restocked on June 24th, 2017. Another restock of the &lsquo;Zebra&rsquo; arrived November 16, 2018, with more pairs hitting the marketplace and delivering on Kanye&rsquo;s promise of Yeezy&rsquo;s being more accessible to anyone that wanted them.",
      upper_material: "Primeknit",
    },
    {
      box_condition: "good_condition",
    ...
    },
    {
      ...
      status: "active",
      story_html:
        "Kanye West and adidas continued their partnership with the Yeezy Boost 350 V2 &lsquo;Butter,&rsquo; which hit stores in June 2018. The minimalist silhouette features distinct center stitching on a reverse Primeknit upper, with the signature &lsquo;SPLY-350&rsquo; inscription now printed on the interior side. The heel tab remains, finished in a bright yellow hue that matches the knitted upper, rope laces, and Boost-infused midsole.",
      upper_material: "Primeknit",
    },
    {
      box_condition: "good_condition",
      ...
      status: "active",
      story_html:
        "Kanye West&rsquo;s Yeezy Boost 350 V2 in Semi Frozen Yellow first hit stores in November 2017, with a restock that released on December 14, 2018. Dressed in adidas&rsquo; signature Primeknit upper, the lifestyle runner is finished in an energetic bright yellow hue, one that extends to the laces, heel tab, and Boost-infused ribbed rubber midsole. Zebra-like black stripes add another design dimension to the upper, along with a tonal side stripe emblazoned with &lsquo;SPLY 350&rsquo; in reverse red print. A gum rubber outsole adds grippy traction to the eye-catching design.",
      upper_material: "Primeknit",
    },
    {
      box_condition: "good_condition",
